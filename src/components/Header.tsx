...
export const Header = () => {
  ...
  return (
    <header className="relative pt-2 text-center space-y-3 animate-fade-in">
      <div className="relative flex flex-col justify-center items-center space-y-1">
        <img 
          ...
          className={`${isMobile ? 'w-36' : 'w-48'} h-auto animate-float`}
        />
        
        <h1 className={`font-display ${isMobile ? 'text-5xl' : 'text-7xl'} font-bold bg-gradient-to-br from-rose-400 via-rose-500 to-rose-600 text-transparent bg-clip-text relative z-10 drop-shadow-[0_0_3px_rgba(255,107,107,0.4)]`}>
          Sprettza
        </h1>
      </div>
      
      <div className="space-y-3 container-width">
